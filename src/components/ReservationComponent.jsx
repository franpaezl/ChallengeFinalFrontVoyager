...
function ReservationComponent() {
    ...
    const [tables, setTables] = useState([
        { id: 1, seats: 2, isSelected: false, isLocked: false },
  ...
  return (
    <div className="p-6 bg-gray-900 rounded-lg border-4 border-red-600 shadow-lg  text-white">
      ...
      <div className="mt-6 text-center">
        <p className="font-semibold mb-4">
          Selected Tables: {tables.filter(t => t.isSelected).length}
        </p>
        <button
