...
const FoodCards = (props) => {
  ...
  return (
    <div className='card-container '>
      ...
      >
        <div className='card-front flex flex-col items-center justify-center rounded-lg'>
          <div className='h-full w-full flex flex-col items-center justify-center bg-white bg-opacity-30 rounded-lg p-4'>
            <h3 className='text-[30px] text-black font-bold mb-2'>{props.name}</h3>
            {/* Removed description and price from the front */}
          </div>
        </div>
        <div className='card-back flex flex-col items-center gap-[10px] justify-center bg-white rounded-lg p-4'>
